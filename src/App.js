    ...
    <Block factor={factor} offset={offset}>
      <group position={[left ? -alignRight : alignRight, 0, 0]}>
        ...
        <HTML
          ...
          <div style={{outline: "none"}} tabIndex={index}>{text}</div>
        </HTML>
  ...
  return (
    <>
      <Block factor={1} offset={0}>
        ...
        <Block factor={1.0}>
          <HTML style={{whiteSpace: "nowrap"}} position={[-w / 3.2, -w * 0.08 + 0.25, -1]}>It was the year 1988,{mobile ? <br /> : " "}a so called mistake was born.</HTML>
        </Block>
      </Block>
      <Block factor={1.2} offset={5.7}>
        <MultilineText top left size={w * 0.15} lineHeight={w / 5} position={[-w / 3.5, 0, -1]} color="#2fe8c3" text={"puff\npuff\npass"} />
      </Block>
      ...
      <Block factor={1.25} offset={8}>
        <HTML className="bottom-left" position={[-canvasWidth / 2, -canvasHeight / 2, 0]}>
          <a rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/tripyy_land/">FIREDEV</a>
        </HTML>
      </Block>
    </>
  )
...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="frame">
        <h1 className="frame__title">@GEMERS_BAND</h1>
